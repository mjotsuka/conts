...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        if traversal_type == 'preorder':
            ...
            x = str(traversal_type)
            raise ValueError('Traversal type ' + x + ' is not supported.')
    ...
    def to_list(self, traversal_type):
        ...
        if traversal_type == 'preorder':
            ...
            x = str(traversal_type)
            raise ValueError('traversal_type=' + x + ' is not supported.')
    ...
    def __len__helper(node):
        ...
        if node is not None and node.left:
            n += BinaryTree.__len__helper(node.left)
        if node is not None and node.right:
            n += BinaryTree.__len__helper(node.right)
        return n + 1
